...
export default function LockedToolCard({ 
  ...
  const cardProps = slug ? { to: `${createPageUrl("Tool")}?slug=${slug}` } : {};
  ...
  return (
    ...
    >
      <CardWrapper {...cardProps} className="block">
        <div className={`glass-card rounded-2xl p-6 h-full transition-all duration-500 cursor-pointer hover:border-[#E1C37A]/30 ${hasAccess ? 'hover:border-green-500/50' : ''}`}>
