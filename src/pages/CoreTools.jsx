    ...
    <div className="min-h-screen pt-24 pb-20">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <span className="text-[#D6D7D8] text-sm font-medium uppercase tracking-wider">Tool Preview</span>
                ...
                <p className="text-[#A9AAAC] mb-6">
                  ...
                  perfectly tailored to each platform. Captions, hashtags, optimal posting times. Done.
                </p>
                <button
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to automate the basics?</h2>
          <p className="text-[#A9AAAC] mb-8 max-w-xl mx-auto">
            Core Tools start at $397/month. That's less than a junior marketer's weekly salary.
          </p>
