      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <SectionHeading
            badge="Contact"
            title="Let's talk."
            subtitle="Book a call or send a message. We respond within 24 hours. Usually faster."
          />
        </div>
      </section>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          className="bg-[#1A1A1C] border-[#3B3C3E] focus:border-[#E1C37A] text-white placeholder:text-[#5B5C60]"
                          required
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        rows={5}
                        className="bg-[#1A1A1C] border-[#3B3C3E] focus:border-[#E1C37A] text-white placeholder:text-[#5B5C60] resize-none"
                        required
                      />
                    </div>
                    ...
                    <p className="text-xs text-[#5B5C60] text-center">
